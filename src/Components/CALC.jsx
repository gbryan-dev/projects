...
const CALC = () => {
  ...
  const buttons = [
    ...
    { label: ".", icon: null, ref: useRef() },
    { label: "=", icon: "fas fa-equals", ref: useRef() },
  ];

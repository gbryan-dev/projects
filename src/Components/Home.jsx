...
const MemoizedAudioPlayer = React.memo(({ audioEl }) => {
  return (
    <ReactAudioPlayer ref={audioEl} src={Sparkle} autoPlay={false} controls />
  );
});
...
const Home = () => {
  ...
  const handlePlay = () => {
    if (audioEl.current && audioEl.current.audioEl.current) {

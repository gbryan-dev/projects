                  ...
                  <div class="p-5">
                    ...
                    <div className="flex justify-between">
                      ...
                      <Link
                        type="button"
                        target={
                          proj.path.includes("gbryan-dev") ? "_blank" : ""
                        }
                        to={proj.path}
                        class="text-white h-[40px] float-right flex w-[120px] bg-gradient-to-br from-sky-400 to-green-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                        Proceed
